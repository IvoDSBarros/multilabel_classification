...
+ In order to provide a *"well-balanced distribution of (...) label relations"*, an interactive stratification was implemented to split data into train(80)/test(20) sets (Szymański, P., Kajdanowicz, T., 2016).
